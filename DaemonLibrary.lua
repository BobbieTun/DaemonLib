if getgenv().DaemonIX and getgenv().DaemonIX.Unload then
    getgenv().DaemonIX:Unload()
end
...
local Library = { } do
    ...
    Library.Directory = "DaemonIX"
    Library.ConfigFolder = "DaemonIX/Configs"
    Library.AssetsFolder = "DaemonIX/Assets"
    ...
    Library.ThemePresets = {
        MakePreset("Obsidian", Library.Theme),
        MakePreset("Gold", {
            ...
            DimText = Color3.fromRGB(140, 130, 110),
            DimIcon = Color3.fromRGB(140, 130, 110),
            Accent = Color3.fromRGB(255, 200, 50)
        }),
        MakePreset("Emerald", {
            Background = Color3.fromRGB(8, 14, 10),
            Section = Color3.fromRGB(12, 20, 15),
            Element = Color3.fromRGB(18, 30, 22),
            Light = Color3.fromRGB(28, 48, 35),
            Hover = Color3.fromRGB(38, 62, 46),
            Line = Color3.fromRGB(18, 30, 22),
            Text = Color3.fromRGB(232, 255, 240),
            DimText = Color3.fromRGB(100, 140, 115),
            DimIcon = Color3.fromRGB(100, 140, 115),
            Accent = Color3.fromRGB(50, 255, 130)
        }),
        MakePreset("Ruby", {
            Background = Color3.fromRGB(14, 8, 10),
            Section = Color3.fromRGB(20, 12, 14),
            Element = Color3.fromRGB(30, 18, 20),
            Light = Color3.fromRGB(48, 28, 32),
            Hover = Color3.fromRGB(62, 36, 40),
            Line = Color3.fromRGB(30, 18, 20),
            Text = Color3.fromRGB(255, 232, 235),
            DimText = Color3.fromRGB(150, 110, 115),
            DimIcon = Color3.fromRGB(150, 110, 115),
            Accent = Color3.fromRGB(255, 50, 80)
        }),
        MakePreset("Amethyst", {
            Background = Color3.fromRGB(12, 10, 16),
            Section = Color3.fromRGB(18, 14, 24),
            Element = Color3.fromRGB(26, 20, 34),
            Light = Color3.fromRGB(40, 30, 54),
            Hover = Color3.fromRGB(52, 38, 70),
            Line = Color3.fromRGB(26, 20, 34),
            Text = Color3.fromRGB(245, 235, 255),
            DimText = Color3.fromRGB(130, 110, 150),
            DimIcon = Color3.fromRGB(130, 110, 150),
